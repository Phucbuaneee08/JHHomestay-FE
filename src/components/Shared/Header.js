    ...
    return (
        <div className="w-full bg-homepage-background bg-cover bg-no-repeat">
            <nav className="w-full">
                <div className=" mx-auto flex items-center justify-between max-w-3/4 w-full">
                    ...
                    <div>
                        ...
                        <div id="menu" className="md:block hidden">
                            <ul className="flex text-3xl  items-center py-10 md:flex flex-col md:flex-row justify-center fixed md:relative top-0 bottom-0 left-0 right-0 bg-white md:bg-transparent z-20">
                                <li className="text-gray-800 hover:text-gray-900 cursor-pointer lg:text-lg pt-10 md:pt-0">
                                    <a href="javascript: void(0)">Thành phố nổi tiếng</a>
                                </li>
                                <li className="text-gray-800 hover:text-gray-900 cursor-pointer lg:text-lg pt-10 md:pt-0 md:ml-5 lg:ml-10">
                                    <a href="javascript: void(0)">Chọn đại 1 tag đi dm</a>
                                </li>
                                <li className="text-gray-800 hover:text-gray-900 cursor-pointer lg:text-lg pt-10 md:pt-0 md:ml-5 lg:ml-10">
                                    <a href="javascript: void(0)">Homestay nổi tiếng</a>
                                </li>
                                <li className="text-gray-800 hover:text-gray-900 cursor-pointer lg:text-lg pt-10 md:pt-0 md:ml-5 lg:ml-10">
                ...
                <div className="container mx-auto flex flex-col items-center py-12 sm:py-24">
                    <div className="w-11/12 sm:w-2/3 mb-5 sm:mb-10 m-5">
