...
const picturelist = fakedataPictureURL.map((item,index) =>
    <div  onClick={()=> showImg(item,index)}>
        <img className="picture" src={item} key={index}></img>
    </div>
)
    ...
    return(
        <div className="max-w-2/3 mx-auto mt-4">
            <div className="grid-container">
                    ...
                    <img onClick={()=> setPictureShow(true)} src = {fakedataPictureURL[2]} className=" picture rounded-tr-xl"></img>
                    <img onClick={()=> setPictureShow(true)} src = {fakedataPictureURL[3]} className=" picture"></img>
                    <img onClick={()=> setPictureShow(true)} src = {fakedataPictureURL[4]} className=" picture rounded-br-xl"></img> 
            </div>
            <div >
                <Modal
                className="modal1"
