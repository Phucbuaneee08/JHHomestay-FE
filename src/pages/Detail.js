    ...
    const fetchData = async () => {
      try {
        const { data: response } = await axios.get(
          "http://localhost:8000/homestays/information/61b75d7ac2faceabc5c96d73"
        );
  ...
  return (
    <div>
      <div>
        ...
        <BookFormModal openProp={[isOpen, setIsOpen]} setConfirmState={setConfirmState} />
      ...
      <div className=" max-w-2/3 mx-auto ">
        <div className="grid grid-cols-5 mt-10 border-b border-gray-300">
          ...
          <div className="col-start-4 col-end-6 ml-32 my-8 border">Booking</div>
        </div>
